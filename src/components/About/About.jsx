...
const About = () => {
  ...
  return (
    <section
      id='about'
      ref={ref}
      className='relative py-32 px-4 md:px-8 lg:px-16 xl:px-40 min-h-screen flex items-center justify-center bg-gray-950 font-sans overflow-hidden'
    >
      {/* Advanced Background */}
      <div className="absolute inset-0">
        {/* Mesh Gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-950 via-gray-900 to-purple-950/30"></div>
        ...
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-purple-600/5 to-blue-600/5 rounded-full blur-3xl"
        />
        <motion.div
          animate={{ x: [0, -100, 0], y: [0, 50, 0] }}
          transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-blue-600/5 to-purple-600/5 rounded-full blur-3xl"
        />
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative">
            ...
            >
              ...
              >
                <div className="w-full h-full rounded-[2.5rem] md:rounded-[3rem] bg-gray-950"></div>
              </motion.div>
              ...
              >
                ...
                <div className="relative w-full pb-[100%]"> {/* Creates perfect square aspect ratio */}
                  ...
                  <div className="absolute inset-4 md:ins-6 rounded-full overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
                    ...
                    <img
                      ...
                      style={{
                        objectPosition: 'center 25%', // Adjust this based on your image
                      }}
                    />
                    ...
                    {/* <motion.div
                      ...
                      animate="float"
                      className="absolute top-4 md:top-6 right-4 md:right-6 bg-gradient-to-r from-purple-600 to-blue-600 p-3 md:p-4 rounded-xl shadow-2xl z-9999 border border-purple-500"
                    >
                      <div className="text-white font-bold text-sm md:text-base">1+ Years</div>
...
{/* 
                    <motion.div
                      ...
                      className="absolute bottom-4 md:bottom-6 left-4 md:left-6 bg-gradient-to-r from-gray-800 to-gray-900 p-3 md:p-4 rounded-xl shadow-2xl border border-gray-700 z-10000"
                    >
                      <div className="text-white font-bold text-sm md:text-base">MERN Stack</div>
                ...
                {/* Bottom Info Bar */}
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-4 md:p-6 backdrop-blur-sm">
            ...
            {/* Optional: Add tech stack below image for mobile */}
